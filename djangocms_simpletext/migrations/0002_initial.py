...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'djangocms_simpletext_simpletext', (
            ...
            ('simpletext', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'djangocms_simpletext_simpletext')
    ...
    models = {
        ...
        u'djangocms_simpletext.simpletext': {
            ...
            'simpletext': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        }
    }
